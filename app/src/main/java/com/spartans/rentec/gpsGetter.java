...
public class gpsGetter {
    ...
    boolean network_enabled=false;
      ...
      /* working codef for gps location
            should be added with main class
        ...
        locationResult = new gpsGetter.LocationResult(){
            ...
            public void gotLocation(Location location){
                ...
                EditText txtLontitude = (EditText)  findViewById(R.id.txtLongtitude);
                String strLongtitude =  Double.toString(longtitude);
                txtLontitude.setText(strLongtitude);
